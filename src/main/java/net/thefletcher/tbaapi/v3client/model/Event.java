...
public class Event {
  ...
  **/
   ...
   * @return week
  **/
  @ApiModelProperty(value = "Week of the event relative to the first official season event. Only valid for Regionals, Districts, and District Championships. Null otherwise.")
